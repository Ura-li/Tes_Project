...
export async function GET() {
    try{
        ...
        worksheetData.push([
            ...
            "PSG",
            "Accessories",
            "Ambient Light,PIXON,PX-5031A,466872-001,MODULE RGB",
            2000000,
            17000,
            50000,
            43.72,
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Part Template");
        ...
        return new NextResponse(buffer, {
            status: 200,
            headers: {
                "Content-Disposition": `attachment; filename="Part_Import_Template.xlsx"`,
                "Content-Type":
